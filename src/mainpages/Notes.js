...
const NotesPanel = ({ currentUser }) => {
  ...
  return (
    <div className="notes-panel">
      <div className="mynotesmessage"><h3>My Notes</h3> </div>
      {message.text && (
      ...
      <button class="noteButton" onClick={handleSaveNote}>Save Note</button>
      ...
      {deleteNoteId && (
        <div className="delete-modal">
          <div className="delete-modal-content">
            <div className= "notesjsmessage"> <p>Are you sure you want to delete this note?</p> </div>
            <button className="confirm-delete" onClick={handleDeleteNote}>
              Yes, Delete
            </button>
            <button className="cancel-delete" onClick={() => setDeleteNoteId(null)}>
              Cancel
            </button>
          </div>
        </div>
